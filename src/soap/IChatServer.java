...
public interface IChatServer {
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "exit", targetNamespace = "http://soap.server.lpi/", className = "soap.Exit")
    @ResponseWrapper(localName = "exitResponse", targetNamespace = "http://soap.server.lpi/", className = "soap.ExitResponse")
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "ping", targetNamespace = "http://soap.server.lpi/", className = "soap.Ping")
    @ResponseWrapper(localName = "pingResponse", targetNamespace = "http://soap.server.lpi/", className = "soap.PingResponse")
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "sendMessage", targetNamespace = "http://soap.server.lpi/", className = "soap.SendMessage")
    @ResponseWrapper(localName = "sendMessageResponse", targetNamespace = "http://soap.server.lpi/", className = "soap.SendMessageResponse")
     ...
     * @param sessionId
     * @return
     *     returns soap.FileInfo
     * @throws ArgumentFault
     * @throws ServerFault
     */
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "receiveFile", targetNamespace = "http://soap.server.lpi/", className = "soap.ReceiveFile")
    @ResponseWrapper(localName = "receiveFileResponse", targetNamespace = "http://soap.server.lpi/", className = "soap.ReceiveFileResponse")
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "listUsers", targetNamespace = "http://soap.server.lpi/", className = "soap.ListUsers")
    @ResponseWrapper(localName = "listUsersResponse", targetNamespace = "http://soap.server.lpi/", className = "soap.ListUsersResponse")
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "sendFile", targetNamespace = "http://soap.server.lpi/", className = "soap.SendFile")
    @ResponseWrapper(localName = "sendFileResponse", targetNamespace = "http://soap.server.lpi/", className = "soap.SendFileResponse")
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "login", targetNamespace = "http://soap.server.lpi/", className = "soap.Login")
    @ResponseWrapper(localName = "loginResponse", targetNamespace = "http://soap.server.lpi/", className = "soap.LoginResponse")
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "receiveMessage", targetNamespace = "http://soap.server.lpi/", className = "soap.ReceiveMessage")
    @ResponseWrapper(localName = "receiveMessageResponse", targetNamespace = "http://soap.server.lpi/", className = "soap.ReceiveMessageResponse")
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "echo", targetNamespace = "http://soap.server.lpi/", className = "soap.Echo")
    @ResponseWrapper(localName = "echoResponse", targetNamespace = "http://soap.server.lpi/", className = "soap.EchoResponse")
